    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="card mt-5">
                    <img class="card-img-top" src="{{ asset('storage/' . $foto->LokasiFile) }}" alt="Foto" style="width: 100%;">
                    <div class="card-body">
                        <h5 class="card-title">{{ $foto->JudulFoto }}</h5>
                        <p class="card-text">Deskripsi : {{ $foto->DeskripsiFoto }}</p>
                        <p class="card-text">Pengunggah : {{ $foto->full_name }}</p>
                        <p class="card-text">Album : {{ $foto->NamaAlbum }}</p>
